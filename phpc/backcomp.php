...
function administrator($script = "")
{
    return isAdministrator($script);
}
...
{
    return getIncrementalValue();
}

function isBanned($blackList)
{
    return isClientBanned($blackList);
}

function trueInteger($value)
{
    return isTrueInteger($value);
}

function trueFloat($value)
{
    return isTrueFloat($value);
}
