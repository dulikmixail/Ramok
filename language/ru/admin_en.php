...
$language["admin_installer_inputhostdesc"]="Адрес хоста, на котором находится база данных.";
...
$language["admin_sitehome_admin"]="Открыть сайт в новом окне";
$language["admin_sitehome_user"]="Выйти из панели управления";
$language["admin_welcome"]="<b>Добро пожаловать в панель управления Elite-Studio!</b><br><br>\r\nОтсюда вы легко сможете управлять возможностями вашего сайта. Пожалуйста, выберите нужный вам пункт в меню слева.";
...
$language["admin_yes"]="Да";
$language["admin_no"]="Нет";
...
$language["admin_toolbar"]="Полезные возможности";
...
$language["admin_error_wrongdb"]="Извините, но ваша БД (%s) не поддерживается плагином.";
