...
class XMLReader
{
    ...
    public function getElements($path, \DOMElement $contextNode = null)
    {
        ...
        if ($this->xpath === null) {
			...
			//регистрируем пространства имен которых не было
			$this->xpath->registerNamespace("a", "http://schemas.openxmlformats.org/drawingml/2006/main");
			$this->xpath->registerNamespace("a:graphic", "http://schemas.openxmlformats.org/drawingml/2006/picture");
			$this->xpath->registerNamespace("a:graphicData", "http://schemas.openxmlformats.org/drawingml/2006/picture");
