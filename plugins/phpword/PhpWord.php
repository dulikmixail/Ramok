...
class PhpWord
{
	...
	public function insert_images($mas_img,$src){
		...
		$link_img=realpath (__DIR__ . "/../../".$mas_img[0]);	//ссылка до картинки полная
		$src = realpath (__DIR__ . "/../../".$src);
		
		//$path_parts = pathinfo($link_img);
		//$link_img=$path_parts['filename'].".".$path_parts['extension']; //имя картинки внутри doc
				
        $image = new Image($link_img);
